...
import com.tysjpt.zhididata.zhididata.Presenter.impl.ZiXunPresenterImpl;
 ...
 */
public class ZiXunContainerFragment extends BaseFragment implements CommonContainerView {
    @InjectView(R.id.fragment_zixun_tab_smart)
    SmartTabLayout smartTabLayout;

    @InjectView(R.id.fragment_zixun_pager)
    ...
    protected void onFirstUserVisible() {
        presenter=new ZiXunPresenterImpl(getContext(),this);
